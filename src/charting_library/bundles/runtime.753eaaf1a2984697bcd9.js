!(function (e) {
  function a(a) {
    for (var c, b, o = a[0], r = a[1], i = a[2], n = 0, l = []; n < o.length; n++)
      (b = o[n]), Object.prototype.hasOwnProperty.call(t, b) && t[b] && l.push(t[b][0]), (t[b] = 0)
        ...
        a.push(
          (b[e] = new Promise(function (a, d) {
            for (
              ...
              var i = (l = f[r]).getAttribute('data-href') || l.getAttribute('href')
              if ('stylesheet' === l.rel && (i === c || i === t)) return a()
            }
            var n = document.getElementsByTagName('style')
            for (r = 0; r < n.length; r++) {
              var l
              if ((i = (l = n[r]).getAttribute('data-href')) === c || i === t) return a()
            }
            ...
            ;(s.rel = 'stylesheet'),
              ...
              (s.onerror = function (a) {
                ...
                ;(f.code = 'CSS_CHUNK_LOAD_FAILED'), (f.request = c), delete b[e], s.parentNode.removeChild(s), d(f)
              }),
              (s.href = t),
